...
@WebServlet("/test04/member/delete")
public class MemberDeleteServlet extends GenericServlet {
  ...
  public void service(ServletRequest request, ServletResponse response)
    ...
    String id = request.getParameter("id");
     //AppInitServlet.memberDao.delete(no);
    //ContextLoaderListener.memberDao.delete(no);
...
Location: http://192.168.0.32:8080/web02t/test02/member/list
